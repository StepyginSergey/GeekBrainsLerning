...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`id`),
  KEY `contry_id_idx` (`contry_id`),
  KEY `region_id_idx` (`region_id`),
  KEY `area_id_idx` (`area_id`),
  CONSTRAINT `city_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`),
  CONSTRAINT `city_ibfk_2` FOREIGN KEY (`contry_id`) REFERENCES `contry` (`id`),
  CONSTRAINT `city_ibfk_3` FOREIGN KEY (`area_id`) REFERENCES `contry` (`id`)
...
INSERT INTO `city` VALUES (1,3,'Серпухов','Моя родина',1,1),(2,4,'Джубга',NULL,2,1);
