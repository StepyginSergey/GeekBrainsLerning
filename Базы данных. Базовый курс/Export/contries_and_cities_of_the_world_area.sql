...
CREATE TABLE `area` (
  ...
  `conrty_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `region_id_idx` (`region_id`),
  KEY `contry_id_idx` (`conrty_id`) /*!80000 INVISIBLE */,
  CONSTRAINT `area_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `region` (`id`),
  CONSTRAINT `area_ibfk_2` FOREIGN KEY (`conrty_id`) REFERENCES `contry` (`id`)
...
INSERT INTO `area` VALUES (3,'Серпуховский район',1,1),(4,'Туапсинский район',2,1);
